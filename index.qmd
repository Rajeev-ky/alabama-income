...
df |> 
  ...
  labs(
    ...
    caption = "Source: https://data.census.gov/table/ACSST1Y2022.S1901",
...
The relation between medain and mean income as shown in Figure 3 is positively correlated. In plot we see that in general mean incomes are more than median incomes of the counties.
