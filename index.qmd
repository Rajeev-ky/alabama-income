...
df |> 
  ...
  scale_y_continuous(labels = scales::label_dollar(scale = 1/1000, suffix = "K")) +
  theme(
    axis.text = element_text(size = 5), plot.tag.position = "bottom", legend.position = ""
  )
```
...
df2 |> 
  ...
  theme(axis.text.x = element_text(angle = 90, size = 6), legend.position = "none", plot.tag.position = "bottom") +
